...
namespace Rialway_system
{
    public partial class search : UserControl
    {
        ...
        {
            SqlConnection connection = new SqlConnection("Data Source=AHMED\\SQLEXPRESS;Initial Catalog=Our_Project;Integrated Security=True");
        ...
        private void searchbott_Click(object sender, EventArgs e)
        {
            ...
            SqlParameter CCount = cmd1.Parameters.Add("@@Ct", SqlDbType.Int);
            CCount.Direction = ParameterDirection.Output;
            cmd1.Parameters.Add(new SqlParameter("@ID", comboBox1.Text));
            cmd1.CommandType = CommandType.StoredProcedure;
           
             cmd1.ExecuteNonQuery();
            label7.Text = CCount.Value.ToString().ToString();
